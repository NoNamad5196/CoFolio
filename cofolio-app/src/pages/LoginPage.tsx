      ...
      <div className="w-full max-w-[440px] reveal in">
        ...
        <div className="mt-7 glass-strong rounded-2xl p-6 ring-grad">
          <div className="grid grid-cols-1 gap-2">
            ...
            <button
              disabled
              className="flex h-11 items-center justify-center gap-2.5 rounded-xl border border-white/10 bg-white/10 text-white/40 text-[14px] font-semibold cursor-not-allowed"
            >
              <svg width="16" height="16" viewBox="0 0 48 48" className="opacity-40">
