      ...
      <div className="w-full max-w-[440px] reveal in">
        ...
        <div className="mt-7 glass-strong rounded-2xl p-6 ring-grad">
          <div className="grid grid-cols-1 gap-2">
            ...
            <button
              onClick={() => submit()}
              className="flex h-11 items-center justify-center gap-2.5 rounded-xl border border-white/10 bg-[#0d1117] hover:bg-[#1a2230] text-white text-[14px] font-semibold"
            >
              <Icon name="github" size={15} /> GitHub로 계속하기
            </button>
            <button
              onClick={() => submit()}
              className="flex h-11 items-center justify-center gap-2.5 rounded-xl bg-[#FEE500] hover:bg-[#fdd835] text-[#191919] text-[14px] font-semibold"
            >
